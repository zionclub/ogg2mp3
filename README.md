...
- **Interface Gráfica Intuitiva:** Layout dividido entre arquivos de origem e preview de saída para total controle antes da conversão.
...
- **Processamento em Background (Threading):** A conversão não trava a interface. Você pode acompanhar o progresso em tempo real através da barra de progresso.
...
3.  **Ordenar:** Escolha entre ordenar por Nome ou Data no painel inferior. O preview na lista da direita será atualizado instantaneamente.
4.  **Converter:** Clique em "Converter" e acompanhe a barra de progresso.
